      ...
      console.log(changeYear);
         ...
         $.ajax({
            ...
            success:function(data){
               ...
               labelData = '['+data.syear+'년 월 매출현황]';
               
               monthData = data.monthData;
               saleData = data.saleData;
//                monthData = ['1월','2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월'];
//                saleData = [1000, 5000, 3000, 5000, 2000, 3000,10000, 5000, 30000, 5000, 2000, 3000];
                 //---------------------------------------------
//                  alert("차트그리기 시작");
  ...
  <div id="syear">
	  <select class ="changeYear" onchange="chartBtn()">
	  	...
	  	<option value="2021">2021년도 매출 현황</option>
	  	<option value="2022">2022년도 매출 현황</option>
	  	<option value="2023">2023년도 매출 현황</option>
	  </select>
  </div>
