...
<html>
	<head>
		...
		<style type="text/css">
			...
			.type1 input{width:20px; height:20px}
		</style>
		<script type="text/javascript">
			...
			function checkIdBtn(){
				...
				$.ajax({
					...
					contentType:"application/json; charset=utf-8;",//데이터를 보낼때의 json타입이다.
					
					dataType:"json",//데이터를 받을때의 json타입
	...
	<body>
		<h2>회원등록</h2>
	 	<form action="memberView" method="post" name="memberFrm" ><!-- 파일첨부 할때 필요 -->
			<table>
				<colgroup>
					<col width="30%">
					<col width="70%">
